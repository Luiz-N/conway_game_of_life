...
function Board(dimension, initialStates) {
  ...
  if (initialStates && initialStates.indexOf('1') != -1) this.setInitialState(initialStates);
}
...
Board.prototype.aliveNeighborCount = function (xPos, yPos) {
  ...
  for (var i = 0; i < transformationRules.length; i++) {
    ...
    if (this.isPositionAlive(neightborXPos, neightborYPos)) {
      aliveCount++;
    }
  }
...
Board.prototype.setInitialState = function (initialStates) {
  ...
  var numOfRows = this.dimension;
  var arrayOfRows = [];

  for (var counter = 0; counter < numOfRows; counter++) {
    var shiftAmount = counter * this.dimension;
    var slicedRow = array.slice(shiftAmount, shiftAmount + this.dimension);
    arrayOfRows.unshift(slicedRow);
  }
  for (var rowIndex = 0; rowIndex < arrayOfRows.length; rowIndex++) {
    ...
    for (var columnIndex = 0; columnIndex < row.length; columnIndex++) {
      if (row[columnIndex] === '1') {
        ...
        this.makeDead(columnIndex, rowIndex);
      }
    }
  }
};
...
},{"./Board":1,"_process":162}],3:[function(require,module,exports){
// main.js
  ...
  render: function () {
    var cellNodes = this.props.cells.map(function (cell) {
      return React.createElement(
        Cell,
        { cellData: cell, key: cell.position },
        ' '
      );
    });
    return React.createElement(
...
var Board = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      'div',
      { className: 'board', key: this.controller },
      React.createElement(
        'span',
        { className: 'counter' },
        this.counter
...
},{"./Controller":2,"classnames":4,"react":161,"react-dom":5}],4:[function(require,module,exports){
/*!
